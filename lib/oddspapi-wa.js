...
const fetchMelbetOddsPapi = makeFetcher('melbet');

module.exports = { fetchBetanoOddsPapi, fetch22BetOddsPapi, fetchMelbetOddsPapi, ODDSPAPI_TOURNAMENT_MAP, DISCOVERY_HINTS };
