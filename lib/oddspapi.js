...
const CONFIRMED_MARKET_NAMES = {
  '1x2':   new Set([]),                    // TODO: exact full-time 1X2 marketName, after checking
  totals:  new Set([]),                    // TODO: exact full-time Over/Under marketName, after checking
  spreads: new Set(['asian handicap']),    // from raw sample 23 Sep 2026: marketName "Asian Handicap", one marketId per line
};
...
function isConfirmedMarket(marketDef) {
  ...
  if (CONFIRMED_MARKET_NAMES[marketDef.marketType].has(name)) return true;
