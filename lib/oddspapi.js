...
// sport, gets funneled through this one chain — so concurrent scans (msport,
// mozzartbet, melbet, betway all racing via Promise.allSettled, across
// multiple sports at once) never fire simultaneous requests or race on
// currentKeyIndex. Previously nothing enforced spacing between calls at all
// — CALL_DELAY_MS existed but was never actually used anywhere in this file.
