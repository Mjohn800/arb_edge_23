...
export const SCANNED_SPORTS = [
  ...
  // US market addition — uses the-odds-api's `us` region (DraftKings,
  // FanDuel) via odds.js's regionsForSport(), not a WA book/scraper.
  'basketball_nba',
];
// Free tier: the 5 lower-volume leagues (fewest arb opportunities). Premium gets all 20
// (21 including NBA — kept off the free tier since it's a new, unproven market).
