...
// ─── BOOKMAKERS ───────────────────────────────────────────────────────────────
const BOOKS = {
  betway:        { name: 'Betway',       momo: true,  licensed: true,  manual: false, url: 'https://betway.com.gh',   note: 'Fastest MoMo payouts in Ghana. GGC licensed 2016.' },
  '1xbet':       { name: '1xBet',        momo: true,  licensed: true,  manual: false, url: 'https://1xbet.com',       note: 'Widest market coverage. Pay within 1-24h.' },
  bet365:        { name: 'Bet365',       momo: false, licensed: false, manual: false, url: 'https://bet365.com',      note: 'Best odds consistency. Card/bank transfer only.' },
  pinnacle:      { name: 'Pinnacle',     momo: false, licensed: false, manual: false, url: 'https://pinnacle.com',    note: 'Sharpest odds worldwide. Does not limit winners.' },
  betfair_ex_eu: { name: 'Betfair',      momo: false, licensed: false, manual: false, url: 'https://betfair.com',     note: 'Betting exchange. Lay bets available.' },
  marathonbet:   { name: 'MarathonBet',  momo: false, licensed: false, manual: false, url: 'https://marathonbet.com', note: 'Good coverage on European football.' },
  unibet_eu:     { name: 'Unibet',       momo: false, licensed: false, manual: false, url: 'https://unibet.com',      note: 'Reliable payouts. European-licensed.' },
  williamhill:   { name: 'William Hill', momo: false, licensed: false, manual: false, url: 'https://williamhill.com', note: 'UK-based. Good for football and horse racing.' },
  melbet:        { name: 'MelBet',       momo: true,  licensed: false, manual: false, url: 'https://melbet.com',      note: 'Accepts MoMo. Wide market selection.' },
  sportybet:     { name: 'SportyBet',    momo: true,  licensed: true,  manual: true,  url: 'https://sportybet.com',   note: 'GGC licensed. Very popular in Ghana. Fast MoMo payouts.' },
  betano:        { name: 'Betano',       momo: true,  licensed: true,  manual: true,  url: 'https://betano.com.gh',   note: 'Launched Ghana Feb 2026. GGC licensed. Mobile-first platform.' },
  msport:        { name: 'MSport',       momo: true,  licensed: true,  manual: true,  url: 'https://msport.com/gh',   note: 'Chelsea FC & BVB partner in Africa. Very competitive odds on football.' },
};
